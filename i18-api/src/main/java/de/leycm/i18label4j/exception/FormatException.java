...
public class FormatException extends RuntimeException {
    ...
    public FormatException(final @NonNull String source, final @NonNull Throwable cause) {
        super(String.format("Value '%s' could not be formated:", source), cause);
    }

    public FormatException(final @NonNull String source, final @NonNull Class<?> clazz, final @NonNull Throwable cause) {
