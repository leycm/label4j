...
public class DeserializationException extends RuntimeException {
    ...
    public DeserializationException(final @NonNull Object source, final @NonNull  Throwable cause) {
        super(String.format("Value '%s' could not be deserialized:", source), cause);
    }

    public DeserializationException(final @NonNull Object source, final @NonNull String reason) {
